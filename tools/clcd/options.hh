...
class Options
{
  public:
    ...
    const mcl::DistanceFunction& function() const { return fun_;    }
  ...
  private:
    ...
    void update(const po::variables_map& map, const char* arg, const char* opt, mcl::DistanceFunction ref);
