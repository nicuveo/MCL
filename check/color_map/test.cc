...
BOOST_AUTO_TEST_CASE(color_map_1)
{
  ...
  BOOST_CHECK_EQUAL(m.get(0.00), mcl::Color(mcl::RED));
  BOOST_CHECK_EQUAL(m.get(0.50), mcl::Color(mcl::OLIVE));
  BOOST_CHECK_EQUAL(m.get(1.00), mcl::Color(mcl::LIME));
}
...
BOOST_AUTO_TEST_CASE(color_map_3)
{
  ...
  BOOST_REQUIRE_EQUAL(i(mcl::RED, mcl::LIME, 0.3), c1);
  BOOST_REQUIRE_EQUAL(i(mcl::RED, mcl::LIME, 0.7), c2);
}
